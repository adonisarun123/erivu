  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FDF7F2' }}>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative overflow-hidden">
        ...
        <div className="absolute top-40 right-40 w-16 h-16 bg-green-200/70 rounded-full opacity-60"></div>
        <div className="absolute top-60 right-10 w-12 h-12 bg-pink-200/70 rounded-full opacity-60"></div>

        <div className="max-w-3xl relative z-10">
          {/* Badges */}
          <div className="flex items-center space-x-4 mb-8">
            <Badge className="bg-green-100 text-green-700 px-4 py-2 backdrop-blur-sm">
              <Shield className="w-4 h-4 mr-2" />
              GI Tagged Authentic
            </Badge>
            <Badge className="bg-yellow-100 text-yellow-700 px-4 py-2 backdrop-blur-sm">
          ...
          {/* Main heading */}
          <h1 className="text-5xl md:text-6xl font-serif font-bold text-gray-900 mb-4 leading-tight drop-shadow-sm">
            Where Every Spice
          </h1>
          <h2 className="text-5xl md:text-6xl font-script font-bold text-red-500 mb-8 leading-tight drop-shadow-sm">
            Tells a Story
          </h2>

          {/* Description */}
          <p className="text-xl text-gray-700 mb-4 max-w-2xl leading-relaxed drop-shadow-sm">
            Discover the authentic taste of Kerala with our premium collection of
          </p>
          <p className="text-xl mb-8 max-w-2xl leading-relaxed drop-shadow-sm">
            <span className="text-yellow-600 font-semibold">GI-tagged spices</span>
            <span className="text-gray-700">, sourced directly from the monsoon-blessed Western Ghats.</span>
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-16">
            ...
            <Button variant="outline" className="px-8 py-3 text-lg border-gray-300 bg-white/80 backdrop-blur-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-8 text-sm">
            <div className="flex items-center">
              ...
              <span className="text-gray-700">GI Certified Quality</span>
            </div>
            <div className="flex items-center">
              <span className="w-5 h-5 text-yellow-500 mr-2">📦</span>
              <span className="text-gray-700">Free Shipping Over ₹999</span>
            </div>
            <div className="flex items-center">
              <Users className="w-5 h-5 text-red-500 mr-2" />
              <span className="text-gray-700">10,000+ Happy Customers</span>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Products Section */}
      <section className="py-20" style={{ backgroundColor: '#FBF3EC' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {products.map((product) => (
              <Card key={product.id} className="group cursor-pointer hover:shadow-xl transition-all duration-300 border-0 bg-white/90 backdrop-blur-sm">
      ...
      {/* Heritage Section */}
      <section className="py-20" style={{ backgroundColor: '#F9EFDC' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <Button className="bg-red-500 hover:bg-red-600 text-white px-8 py-3 shadow-lg">
      ...
      {/* Why Erivu Section */}
      <section className="py-20" style={{ backgroundColor: '#F7E6D3' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center p-8 border-0 bg-red-50/80 backdrop-blur-sm shadow-lg">
            ...
            <Card className="text-center p-8 border-0 bg-green-50/80 backdrop-blur-sm shadow-lg">
            ...
            <Card className="text-center p-8 border-0 bg-yellow-50/80 backdrop-blur-sm shadow-lg">
